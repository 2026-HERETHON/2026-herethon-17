...
| `PM` | `BE` | `BE` | `FE` | `FE` | `FE` |
| **[ 기획 ]**<br>- 서비스 이름<br>- 서비스 소개<br>- 타겟사용자<br>- 차별화 포인트<br>- IA + 기능 명세서<br>- BM 설계<br><br> **[ 디자인 ]**<br>- 로고<br>- 디자인 시스템<br>- 와이어프레임<br>- 프로토타입<br>- 발표 자료 | - 역할2 | - 역할3 | - 나의 정원<br>- 허브 커뮤니티<br>- 마이페이지 | - 증상 트래커<br>- 패턴 리포트 | - 온보딩<br>- 홈 |
